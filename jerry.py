...
img_fb = PhotoImage(file="/home/pi/GUI/Icons/fb_s.png")
...
img_tw = PhotoImage(file="/home/pi/GUI/Icons/twitter_s.png")
...
img_insta = PhotoImage(file="/home/pi/GUI/Icons/insta_s.png")
...
img_yt = PhotoImage(file="/home/pi/GUI/Icons/yt_s.png")
...
img_reg = PhotoImage(file="/home/pi/GUI/Icons/regis.png")
...
img_login = PhotoImage(file="/home/pi/GUI/Icons/login.png")
...
img_msg = PhotoImage(file="/home/pi/GUI/Icons/msg.png")
...
img_edit=PhotoImage(file="/home/pi/GUI/Icons/edit.png")
...
sign_in.configure(width=3)
sign_in_window = canvas_middle.create_window(458, 86, anchor=NW, window=sign_in)
...
img_face=PhotoImage(file="/home/pi/GUI/Icons/face_m.png")
